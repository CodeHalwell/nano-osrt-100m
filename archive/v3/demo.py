        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                top_p = gr.Slider(
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Nucleus sampling: filters out low probability tokens.",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits sampling to the K most likely tokens.",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes recently generated tokens to reduce repetition.",
                )
