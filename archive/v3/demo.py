        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                temperature = gr.Slider(
                    ...
                    step=0.05,
                    label="Temperature",
                    info="Controls randomness. Higher values are more creative.",
                )
                top_p = gr.Slider(
                    minimum=0.0,
                    maximum=1.0,
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Limits generation to most probable tokens.",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits sampling to k most likely next tokens.",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes repeated tokens. Values > 1.0 reduce repetition.",
                )
