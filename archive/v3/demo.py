        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                temperature = gr.Slider(
                    ...
                    step=0.05,
                    label="Temperature",
                    info="Higher values produce more creative responses",
                )
                top_p = gr.Slider(
                    minimum=0.0,
                    maximum=1.0,
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Limits token selection to cumulative probability pool",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits token selection to top K candidates",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes repeated tokens (1.0 = off)",
                )
