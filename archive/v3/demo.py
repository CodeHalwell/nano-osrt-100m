        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                top_p = gr.Slider(
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Limits choices to top cumulative probability.",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits choices to the K most likely next words.",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes repeated words. >1 encourages new words.",
                )
