        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                top_p = gr.Slider(
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Limits token pool to cumulative probability (0.0 to disable)",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits token pool to top K choices (0 to disable)",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes tokens already generated (1.0 to disable)",
                )
