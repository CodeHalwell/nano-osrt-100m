        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                top_p = gr.Slider(
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Nucleus sampling: bounds the vocabulary to the most likely tokens.",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits the next token choices to the K most probable tokens.",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes already generated tokens to reduce repetition.",
                )
