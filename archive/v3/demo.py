...
def create_demo():
    with gr.Blocks(title="NanoOSRT v3") as demo:
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                temperature = gr.Slider(
                    ...
                    step=0.05,
                    label="Temperature",
                    info="Controls randomness. Higher values increase creativity, lower values increase focus.",
                )
                top_p = gr.Slider(
                    minimum=0.0,
                    maximum=1.0,
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Nucleus sampling. Limits choices to top tokens whose probabilities sum to this value.",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits choices to the K most probable tokens. Set to 0 to disable.",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes repeated words. 1.0 disables the penalty.",
                )
        ...
        def respond(
            ...
            if len(message) > 4000:
                raise gr.Error("Message is too long. Please limit to 4000 characters.")
