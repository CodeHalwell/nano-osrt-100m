        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                top_p = gr.Slider(
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Nucleus sampling: limits choices to cumulative probability p",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits token choices to the k most probable tokens",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes recently generated tokens (1.0 = disabled)",
                )
