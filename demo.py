        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                top_p = gr.Slider(
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Nucleus sampling. Limits choices to top cumulative prob.",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits choices to K most likely next tokens.",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes repeated tokens. >1.0 reduces loops.",
                )
