        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                temperature = gr.Slider(
                    ...
                    step=0.05,
                    label="Temperature",
                    info="Controls randomness. Higher values increase creativity.",
                )
                top_p = gr.Slider(
                    minimum=0.0,
                    maximum=1.0,
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Nucleus sampling. Limits choices to the top cumulative probability.",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes repeating previously generated tokens.",
                )
