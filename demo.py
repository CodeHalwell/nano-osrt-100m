        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                top_p = gr.Slider(
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Nucleus sampling: only consider tokens with top p probability mass.",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Only consider the top K tokens for generation.",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalize repeating tokens. 1.0 means no penalty.",
                )
