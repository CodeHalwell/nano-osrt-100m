        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                top_p = gr.Slider(
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Nucleus sampling. Lower values focus on likely tokens.",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits token selection to the K most likely options.",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes repeated tokens. Values > 1 reduce repetition.",
                )
