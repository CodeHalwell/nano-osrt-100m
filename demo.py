        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                temperature = gr.Slider(
                    ...
                    step=0.05,
                    label="Temperature",
                    info="Controls randomness: lower is deterministic.",
                )
                top_p = gr.Slider(
                    minimum=0.0,
                    maximum=1.0,
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Nucleus sampling: bounds the cumulative probability.",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits the next token selection to K most probable.",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Penalizes repeated tokens. >1.0 reduces repetition.",
                )
