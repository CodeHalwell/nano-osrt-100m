        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                temperature = gr.Slider(
                    ...
                    step=0.05,
                    label="Temperature",
                    info="Controls randomness. Lower is more deterministic, higher is more creative.",
                )
                top_p = gr.Slider(
                    minimum=0.0,
                    maximum=1.0,
                    ...
                    step=0.05,
                    label="Top-p",
                    info="Nucleus sampling. Limits choices to cumulative probability of p.",
                )
                top_k = gr.Slider(
                    minimum=0,
                    maximum=100,
                    ...
                    step=5,
                    label="Top-k",
                    info="Limits choices to the k most likely next tokens.",
                )
                ...
                repetition_penalty = gr.Slider(
                    ...
                    info="Prevents the model from repeating the same words.",
                )
