        ...
        **kwargs,
        ...
        for _ in range(max_new_tokens):
            ...
            if repetition_penalty != 1.0:
                # ⚡ Bolt: Vectorize repetition penalty calculation
                # Replaced Python loop and list conversion with vectorized PyTorch operations
                # avoiding expensive CPU-GPU synchronization in the autoregressive loop
