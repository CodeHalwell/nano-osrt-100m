        ...
        **kwargs,
        ...
        for _ in range(max_new_tokens):
            ...
            if repetition_penalty != 1.0:
                max_idx = max(next_logits.shape[-1], generated.max().item() + 1)
                ...
                expanded_mask.scatter_(1, generated, True)
                mask = expanded_mask[:, : next_logits.shape[-1]]
                ...
                next_logits = torch.where(mask, penalized, next_logits)
