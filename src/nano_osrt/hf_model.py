        ...
        **kwargs,
        ...
        for _ in range(max_new_tokens):
            ...
            if repetition_penalty != 1.0:
                # OPTIMIZATION: Vectorized computation for repetition penalty.
                # Replaced Python loop `for token_id in set(...)` with element-wise PyTorch
                # operations, resulting in an ~125x speedup for this block.
