...
class NanoOSRTForCausalLM(nn.Module):
    ...
    def generate(
        ...
        **kwargs,
        ...
        """Generate tokens autoregressively with top-p sampling and penalty."""
        ...
        for _ in range(max_new_tokens):
            ...
            if repetition_penalty != 1.0:
                # Vectorized penalty to avoid Python loops in generation
                # Get unique generated tokens
                generated_tokens = generated[0].unique()
                # Filter out tokens beyond vocabulary size
                valid_tokens = generated_tokens[
                    generated_tokens < next_logits.shape[-1]
                ]
