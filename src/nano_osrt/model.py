...
def apply_rope(x: Tensor, cos: Tensor, sin: Tensor) -> Tensor:
    ...
    # ⚡ Bolt Optimization:
    # We calculate the slices and concatenate directly rather than allocating
    # an intermediate full-size tensor `x_rot`. This reduces memory bandwidth
    # overhead and reduces latency slightly on CPU and GPU.
    return torch.cat(
