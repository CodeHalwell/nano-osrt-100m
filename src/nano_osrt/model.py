...
def apply_rope(x: Tensor, cos: Tensor, sin: Tensor) -> Tensor:
    ...
    # Optimization: Calculate directly and concatenate to avoid allocating the
    # full size intermediate tensor x_rot. This reduces memory bandwidth usage
    # and provides a measurable latency reduction.
    return torch.cat(
