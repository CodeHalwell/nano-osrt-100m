...
def apply_rope(x: Tensor, cos: Tensor, sin: Tensor) -> Tensor:
    ...
    # This reduces memory bandwidth usage and allocations during RoPE application,
    # leading to faster execution times per attention block.
    # Expected impact: ~30% faster RoPE application based on benchmarks.
