...
def apply_rope(x: Tensor, cos: Tensor, sin: Tensor) -> Tensor:
    ...
    # ⚡ Bolt Optimization:
    # Avoid allocating a full-size intermediate `x_rot` tensor.
    # Calculate and concatenate the results directly to reduce memory bandwidth
    # and allocation overhead during element-wise math on sliced tensors.
